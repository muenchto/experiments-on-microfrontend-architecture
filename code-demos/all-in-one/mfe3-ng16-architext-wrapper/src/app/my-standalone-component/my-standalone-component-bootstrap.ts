...
export async function bootstrapMyComponentAsync(): Promise<void> {
  ...
  const customElementCtor: CustomElementConstructor | undefined = customElements.get('my-mfe3-component');
  ...
  customElements.define('my-mfe3-component', myStandaloneComponentAsWebComponent);
}
