import { Component, EventEmitter, Input, OnInit, Output, VERSION, ViewEncapsulation, inject } from '@angular/core';
import { CommonModule } from '@angular/common';
import { OnDestroy } from '@angular/core';
import { map, tap } from 'rxjs';
import { Mfe2StoreService } from '../mfe2-store.service';
...
export class MyStandaloneComponent implements OnDestroy, OnInit {
  ...
  private store = inject(Mfe2StoreService);
